...
<div class="col-md-4 col-md-offset-8">
    ...
    <table class="items table table-bordered">
        <tr><td>Pušteno naloga</td><td class="text-right"><?=number_format($total_web_orders,0,',','.');?></td></tr>
        <tr><td>Urađeno artikala</td><td class="text-right"><?=number_format($completed_web_products,0,',','.');?></td></tr>
        <tr><td>Urađeno komada</td><td class="text-right"><?=number_format($completed_web_quantity,0,',','.');?></td></tr>
    </table>
...
<?php $this->widget('ext.groupgridview.BootGroupGridView', array(
    ...
    'columns' => array(
        ...
        array(
            ...
            'header' => 'Broj naloga',
            'type' => 'raw',
            'value' => 'CHtml::link($data->order_number, Yii::app()->createUrl("/webOrder/".$data->id),array("target"=>"_blank"))',

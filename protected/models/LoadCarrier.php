...
/**
 * This is the model class for table "load_carrier".
 *
 * The followings are the available columns in table 'load_carrier':
 * @property integer $id
 ...
 */
class LoadCarrier extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, material, width, length, height, gross_weight, created_user_id, created_dt, updated_user_id, updated_dt', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'products' => array(self::HAS_MANY, 'Product', 'load_carrier_id'),
		);
	}
	 ...
	 * @return LoadCarrier the static model class
	 */
	...
	public function beforeSave()
	{
        ...
        $this->gross_weight = str_replace(',','.',$this->gross_weight);

...
class ActivityAttachment extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('activity_id, created_user_id, updated_user_id', 'numerical', 'integerOnly'=>true),
			array('filename, filepath, created_dt, updated_dt', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, activity_id, filename, filepath, created_user_id, created_dt, updated_user_id, updated_dt', 'safe', 'on'=>'search'),
		);
	}

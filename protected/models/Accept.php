 ...
 *
 * The followings are the available columns in table 'accept':
 * @property integer $id
 ...
 */
class Accept extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('activity_palett_id, sscc', 'required'),
			array('activity_palett_id, status, created_user_id, updated_user_id', 'numerical', 'integerOnly'=>true),
			array('sscc', 'length', 'max'=>255),
			array('created_dt, updated_dt', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, activity_palett_id, sscc, status, created_user_id, created_dt, updated_user_id, updated_dt', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Accept the static model class
	 */

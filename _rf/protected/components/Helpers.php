...
class Helpers extends CApplicationComponent {
    ...
    public function saveLog($model)
    {
        
        $change_log = new ChangeLog;
        
        $change_log->attributes = array(
    ...
    public function getMonths($month = false) {
        $months = array(
    ...
    public static function getWeekdays($day = false) {
            $days = array(
    ...
    public static function safe_string($oldstring, $wordsreturned) {
    ...
    public static function numberArray($start,$stop)
    {
        $result = array();
